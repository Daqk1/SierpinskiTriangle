...
// In the draw() method or wherever you are calling the rendering functions

//create a hitbox for each of the tttFullBoard. That hitbox will be assigned a #, and when mousePressed on that number, set the corresponding box to that X
...
public void mousePressed() {
  ...
  //  if (n2[a].getWhoWon() == n2[b].getWhoWon() && n2[b].getWhoWon() == n2[c].getWhoWon()) {
...
//    if (n1[a].getXorO() == n1[b].getXorO() && n1[b].getXorO() == n1[c].getXorO()) {
//      whoWon = n1[a].getXorO();
//      victory = true;
//    }
//  }
public void checkWinRow(int a, int b, int c) {
  ...
  //    biggerX(n1[4].getClickSpaceX(), n1[4].getClickSpaceY()); //create a parameter for createSquare that take in locationX and locationY
  //          temp.add(number);
  //  }
  //}
  public void whoWon(){
